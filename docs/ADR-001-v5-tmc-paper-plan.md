...
- Status: **Active — M5 complete; pivoted to Path B (centralized Spiking-SSM benchmark on ColO-RAN) per 2026-04-25 Fermi analysis. Stage 1 target: IoTJ / TNSM / Globecom short paper. Stage 2 (FL upgrade) conditional on Stage 1 GO/NO-GO. M6 (FedBN gap) deferred to Stage 2.**
